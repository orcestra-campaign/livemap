  ...
  render() {
    return (
        <Container>
			<h2>General</h2>
            <p>
				The EUREC<sup>4</sup>A MQTT Dashboard shows information currently transferred via the <a href="http://eurec4a.eu/">EUREC<sup>4</sup>A</a> field campaigns <a href="https://en.wikipedia.org/wiki/MQTT">MQTT</a> broker.
			</p>
			<h2>Data</h2>
