  ...
  render() {
    return (
        <Container>
			<h2>General</h2>
            <p>
				The ORCESTRA Livemap shows information currently transferred via the <a href="https://orcestra-campaign.org/">ORCESTRA</a> field campaigns <a href="https://en.wikipedia.org/wiki/MQTT">MQTT</a> broker.
			</p>
			<h2>Data</h2>
			...
			<h2>Code</h2>
				The <a href="https://github.com/orcestra-campaign/livemap">code for the dashboard</a> and the <a href="https://github.com/orcestra-campaign/mqtt_spec/blob/master/mqtt_spec.md">specification for the MQTT messages</a> exchanged over the broker can be found on github.
